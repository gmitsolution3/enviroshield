...
export function Button({
  ...
  const inner = (
    <motion.span
      className={`inline-flex min-h-12 items-center justify-center gap-[9px] rounded-[10px] px-5 text-[13px] font-bold tracking-[0.01em] transition-[background-color,box-shadow] duration-200 !rounded-4xl ${variantClasses[variant]} ${className}`}
